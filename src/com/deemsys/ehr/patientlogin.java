...
public void onCreate(Bundle savedInstanceState)
{
    ...
    setContentView(R.layout.patientlogin_layout);
    logging();
    Button registerpatient = (Button)findViewById(R.id.register);

    registerpatient.setOnClickListener(new View.OnClickListener() {

      @Override
      public void onClick(View view) {
        Intent intent = new Intent(patientlogin.this, patientregist.class);
